...
% We employ layer-wise partitioning to the large models to allow for sequential execution of the parts.
% TODO add more info about partitioning


%%%
The memory capacity of the \graicore{} is limited to \SI{36}{MiB}.
% This is a relatively small value and many models exist that do not fit on this amount of memory, even after applying model optimizations.
...
The ResNet-101 model is therefore partitioned in 5 parts.
