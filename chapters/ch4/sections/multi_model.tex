...
% Suppose we want to process every new incoming frame with another model, all with a frame processing latency of \SI{5}{ms}. 
...
% In the long run, latency will continue to increase, eventually leading to erroneous behavior in the system.
