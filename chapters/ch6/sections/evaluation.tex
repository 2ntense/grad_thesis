...
Shown in \cref{fig:resnet50_conf_proc}, the configuration of the ResNet-50 model occupies around 21\% with LPDDR5X and 11\% with PCM of the total energy consumption (processing and configuration).
