To obtain an insight into the power consumption with the introduction of the \confignoc{} changes in \cref{ch:5} and model configuration using external memory we will provide a comprehensive analysis.
