...
% A neuron that receives input values from its connected neurons multiplies this value by their corresponding weights before being aggregated by the receiving neuron (see \cref{fig:neuron}).
...
% This non-linearity is crucial for the network to learn complex patterns and relationships in the data.
%%%
