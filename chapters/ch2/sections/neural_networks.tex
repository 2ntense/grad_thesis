...
\begin{description}
    ...
    Each hidden layer typically consists of many neurons, each applying a non-linear transformation to the weighted sum of its inputs. % TODO add activation function explanation
