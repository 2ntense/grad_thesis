...
\begin{description}
    ...
    This accounts for the energy consumed in reading data from the external DDR memory and transferring it through the DDR PHY, DDR controller, AXI bus, and \confignoc{} to the local SRAMs of the cores.
    ...
    \begin{eqexpl}
        ...
        \item{$\enoc(p_i, \pi_i)$} energy consumed by the \confignoc{} during the transfer of the data to their respective destination cores.
