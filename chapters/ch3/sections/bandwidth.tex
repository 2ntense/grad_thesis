...
% Furthermore, since we are primarly interested in writing data to the \graicore{}, the single injection point into the \confignoc{} does not introduce contention for the links, maximizing bandwidth utilization.
% Since we are primarily intereseted in writing data to the \graicore{}, the single injection point into the \confignoc{} prevents contention for network links.
% As a consequence, this does not negatively affect the bandwidth utilization.
