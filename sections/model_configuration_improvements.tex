The process of configuring a model on the GrAICore is the reading of the required data from the external memory, transferring it to the GrAICore's neuron cores and writing the data to the SRAMs.
